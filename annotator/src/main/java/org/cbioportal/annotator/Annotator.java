...
public interface Annotator {
    ...
    AnnotatedRecord annotateRecord(MutationRecord record, boolean replaceHugo, String isoformOverride, boolean reannotate, String stripMatchingBases, Boolean ignoreOriginalData, Boolean addOriginalGenomicLocation) throws GenomeNexusAnnotationFailureException;
    List<AnnotatedRecord> annotateRecordsUsingGET(AnnotationSummaryStatistics summaryStatistics, List<MutationRecord> mutationRecords, String isoformOverridesSource, Boolean replace, boolean reannotate, String stripMatchingBases, Boolean ignoreOriginalData, Boolean addOriginalGenomicLocation);
